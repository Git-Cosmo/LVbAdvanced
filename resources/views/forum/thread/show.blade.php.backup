...
<div class="max-w-7xl mx-auto">
    ...
    <nav class="mb-6 flex items-center space-x-2 dark:text-dark-text-secondary text-light-text-secondary text-sm">
        ...
        <span>›</span>
        <a href="{{ route('forum.show', $thread->forum->category->slug) }}" class="dark:hover:text-dark-text-accent hover:text-light-text-accent">{{ $thread->forum->category->name }}</a>
        <span>›</span>
    ...
    <div class="dark:bg-dark-bg-secondary bg-light-bg-secondary rounded-xl mb-4 overflow-hidden">
        <div class="flex">
            <!-- User Sidebar -->
            ...
            <div class="flex-1 p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    @auth
                    @can('update', $post)
                    <button class="text-sm dark:text-dark-text-accent text-light-text-accent dark:hover:text-dark-text-bright hover:text-light-text-bright">
                        Edit
                    </button>
                    @endcan
                    @endauth
                ...
                <div class="mt-4 flex items-center space-x-2">
                    <button class="px-3 py-1 rounded-lg dark:bg-dark-bg-elevated bg-light-bg-elevated dark:hover:bg-dark-bg-tertiary hover:bg-light-bg-tertiary transition-colors text-sm">
