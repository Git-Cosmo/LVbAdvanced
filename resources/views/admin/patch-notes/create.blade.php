...
@section('title', 'Create Patch Note')
@section('header', 'Create Patch Note')

@section('content')
<div class="max-w-4xl">
    <form action="{{ route('admin.patch-notes.store') }}" method="POST">
        @csrf
        ...
        <div class="dark:bg-dark-bg-secondary bg-light-bg-secondary rounded-lg shadow p-6 mb-6">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="game_name" id="game_name" value="{{ old('game_name') }}" required
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description" rows="2"
                    class="w-full px-3 py-2 border dark:border-dark-border-primary border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-dark-bg-tertiary dark:text-dark-text-bright @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
            ...
            <div class="mb-4">
                ...
                <textarea name="content" id="content" rows="15" required
                    class="w-full px-3 py-2 border dark:border-dark-border-primary border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-dark-bg-tertiary dark:text-dark-text-bright font-mono text-sm @error('content') border-red-500 @enderror">{{ old('content') }}</textarea>
        ...
        <div class="dark:bg-dark-bg-secondary bg-light-bg-secondary rounded-lg shadow p-6 mb-6">
            ...
            <div class="mb-4">
                ...
                <input type="datetime-local" name="released_at" id="released_at" value="{{ old('released_at', now()->format('Y-m-d\TH:i')) }}"
                    class="w-full px-3 py-2 border dark:border-dark-border-primary border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-dark-bg-tertiary dark:text-dark-text-bright">
            </div>
