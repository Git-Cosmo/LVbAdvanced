...
@section('title', 'Edit Game Server')
@section('header', 'Edit Game Server')

@section('content')
<div class="max-w-4xl">
    <form action="{{ route('admin.game-servers.update', $gameServer) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="dark:bg-dark-bg-secondary bg-light-bg-secondary rounded-lg shadow p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $gameServer->name) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="game" id="game" value="{{ old('game', $gameServer->game) }}" required
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div>
                    ...
                    <input type="text" name="game_short_code" id="game_short_code" value="{{ old('game_short_code', $gameServer->game_short_code) }}" maxlength="10" required
                        class="w-full px-3 py-2 border dark:border-dark-border-primary rounded-lg dark:bg-dark-bg-tertiary dark:text-dark-text-bright">
                </div>

                <div>
                    <label for="game_mode" class="block text-sm font-medium dark:text-dark-text-primary mb-1">Game Mode</label>
                    <input type="text" name="game_mode" id="game_mode" value="{{ old('game_mode', $gameServer->game_mode) }}"
                        class="w-full px-3 py-2 border dark:border-dark-border-primary rounded-lg dark:bg-dark-bg-tertiary dark:text-dark-text-bright">
                </div>

                <div>
                    <label for="display_order" class="block text-sm font-medium dark:text-dark-text-primary mb-1">Display Order</label>
                    <input type="number" name="display_order" id="display_order" value="{{ old('display_order', $gameServer->display_order) }}" min="0"
                        class="w-full px-3 py-2 border dark:border-dark-border-primary rounded-lg dark:bg-dark-bg-tertiary dark:text-dark-text-bright">
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description" rows="2"
                    class="w-full px-3 py-2 border dark:border-dark-border-primary rounded-lg dark:bg-dark-bg-tertiary dark:text-dark-text-bright">{{ old('description', $gameServer->description) }}</textarea>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div>
                    <label for="ip_address" class="block text-sm font-medium dark:text-dark-text-primary mb-1">IP Address</label>
                    <input type="text" name="ip_address" id="ip_address" value="{{ old('ip_address', $gameServer->ip_address) }}"
                        class="w-full px-3 py-2 border dark:border-dark-border-primary rounded-lg dark:bg-dark-bg-tertiary dark:text-dark-text-bright">
                </div>

                <div>
                    <label for="port" class="block text-sm font-medium dark:text-dark-text-primary mb-1">Port</label>
                    <input type="number" name="port" id="port" value="{{ old('port', $gameServer->port) }}" min="1" max="65535"
                        class="w-full px-3 py-2 border dark:border-dark-border-primary rounded-lg dark:bg-dark-bg-tertiary dark:text-dark-text-bright">
                </div>
                ...
                <div>
                    ...
                    <select name="status" id="status" required class="w-full px-3 py-2 border dark:border-dark-border-primary rounded-lg dark:bg-dark-bg-tertiary dark:text-dark-text-bright">
                        <option value="coming_soon" {{ old('status', $gameServer->status) === 'coming_soon' ? 'selected' : '' }}>Coming Soon</option>
                        <option value="online" {{ old('status', $gameServer->status) === 'online' ? 'selected' : '' }}>Online</option>
                        <option value="offline" {{ old('status', $gameServer->status) === 'offline' ? 'selected' : '' }}>Offline</option>
                        <option value="maintenance" {{ old('status', $gameServer->status) === 'maintenance' ? 'selected' : '' }}>Maintenance</option>
                    </select>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="number" name="max_players" id="max_players" value="{{ old('max_players', $gameServer->max_players) }}" min="0"
                        class="w-full px-3 py-2 border dark:border-dark-border-primary rounded-lg dark:bg-dark-bg-tertiary dark:text-dark-text-bright">
                </div>

                <div>
                    <label for="current_players" class="block text-sm font-medium dark:text-dark-text-primary mb-1">Current Players</label>
                    <input type="number" name="current_players" id="current_players" value="{{ old('current_players', $gameServer->current_players) }}" min="0"
                        class="w-full px-3 py-2 border dark:border-dark-border-primary rounded-lg dark:bg-dark-bg-tertiary dark:text-dark-text-bright">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="color" name="icon_color_from" id="icon_color_from" value="{{ old('icon_color_from', $gameServer->icon_color_from) }}" required
                ...
                <div>
                    ...
                    <input type="color" name="icon_color_to" id="icon_color_to" value="{{ old('icon_color_to', $gameServer->icon_color_to) }}" required
                        class="w-full h-10 border dark:border-dark-border-primary rounded-lg dark:bg-dark-bg-tertiary">
                </div>
            </div>
            ...
            <div class="flex items-center space-x-6 mb-4">
                <label class="flex items-center">
                    <input type="checkbox" name="is_featured" value="1" {{ old('is_featured', $gameServer->is_featured ? '1' : '0') == '1' ? 'checked' : '' }}
                        class="rounded border-gray-300 text-primary-600 focus:ring-primary-500">
                    <span class="ml-2 text-sm dark:text-dark-text-primary">Featured</span>
                </label>

                <label class="flex items-center">
                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', $gameServer->is_active ? '1' : '0') == '1' ? 'checked' : '' }}
                        class="rounded border-gray-300 text-primary-600 focus:ring-primary-500">
