...
<div class="mb-6 flex justify-between items-center">
    ...
    <a href="{{ route('admin.pages.create') }}" class="bg-primary-600 hover:bg-primary-700 text-white px-4 py-2 rounded-lg transition">
        Create New Page
    </a>
</div>
            ...
            @forelse($pages as $page)
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        @if($page->is_homepage)
                            <span class="text-primary-600 font-semibold">✓ Homepage</span>
                        @endif
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <a href="{{ route('admin.pages.edit', $page) }}" class="text-primary-600 hover:text-primary-900 mr-3">Edit</a>
