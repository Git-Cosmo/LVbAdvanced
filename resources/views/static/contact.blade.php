                ...
                <div class="dark:bg-dark-bg-secondary bg-light-bg-secondary rounded-xl shadow-lg p-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex flex-wrap gap-3">
                            <a href="#" class="flex items-center space-x-2 px-4 py-2 dark:bg-dark-bg-tertiary bg-light-bg-tertiary rounded-lg hover:bg-accent-blue hover:text-white transition-colors">
