            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="text-sm dark:text-dark-text-tertiary text-light-text-tertiary">Event Type</p>
                            <p class="dark:text-dark-text-bright text-light-text-bright">
                                @if($event->is_virtual)
                                <span class="inline-flex items-center px-2 py-1 rounded-full bg-purple-500/20 text-purple-400 text-sm">
                                ...
                                @else
                                <span class="inline-flex items-center px-2 py-1 rounded-full bg-green-500/20 text-green-400 text-sm">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                                    </svg>
                                    In-Person Event
