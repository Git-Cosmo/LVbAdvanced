            ...
            <div class="lg:col-span-2">
                ...
                @if($streamerBan->ban_history && count($streamerBan->ban_history) > 0)
                    <div class="dark:bg-dark-bg-secondary bg-light-bg-secondary rounded-xl p-6 shadow-lg">
                        ...
                        <div class="space-y-4">
                            @foreach($streamerBan->ban_history as $ban)
                                <div class="p-4 dark:bg-dark-bg-tertiary bg-light-bg-tertiary rounded-lg">
                                    @if(isset($ban['date']))
                                        <div class="flex items-center justify-between mb-2">
                                            <span class="font-semibold dark:text-dark-text-bright text-light-text-bright">
                                                {{ $ban['date'] }}
                                            </span>
                                    ...
                                    @if(isset($ban['text']) && !isset($ban['date']))
                                        <p class="text-sm dark:text-dark-text-secondary text-light-text-secondary">
                                            {{ $ban['text'] }}
                                        </p>
                                    @endif
                ...
                @else
                    <div class="dark:bg-dark-bg-secondary bg-light-bg-secondary rounded-xl p-8 text-center">
                        ...
                        <p class="dark:text-dark-text-secondary text-light-text-secondary">No detailed ban history available</p>
                    </div>
                @endif
            </div>
